...
class CommonFragment : BaseFragment<FragmentCommonBinding>() {
    ...
    override fun initObservers() {
        ...
        with(viewModel) {
            sortedListToView.observe(viewLifecycleOwner, { list ->
                observeListActon(popularCurrencyList, list)
            })

            favouriteListToView.observe(viewLifecycleOwner, { list ->
                observeListActon(favouriteCurrencyList, list)
            })

            errorListener.observe(viewLifecycleOwner, { isError ->
